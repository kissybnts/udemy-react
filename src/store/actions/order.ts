...
interface FetchOrdersRequestAction extends Action {}
...
interface FetchOrdersRequestSuccessAction extends Action {
  orders: Order[];
}
...
interface FetchOrdersRequestFailAction extends Action {
  error: any;
}
...
interface FetchOrdersRequestStartAction extends Action {}
